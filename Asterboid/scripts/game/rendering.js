...
g58.rendering.render = function () {    
    g58.g.camera.frame = g58.g.cameraBlock.frame.clone();
    g58.g.camera.frame.translateInOwnFrame(
    ...
    g58.g.ship.frame = g58.g.cameraBlock.frame.clone();
    g58.g.ship.frame.translateInOwnFrame(
